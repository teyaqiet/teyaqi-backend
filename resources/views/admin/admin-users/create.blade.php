...
@section('title', 'Create Admin User — Teyaqi')
...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold tracking-tight text-gray-900">Create Admin User</h1>
            <p class="mt-1 text-xs text-gray-500">Add a new administrator account and assign system permissions.</p>
        </div>
    ...
    <div class="w-full rounded-2xl border border-gray-100 bg-white p-6 shadow-xl shadow-black/5 sm:p-8">
        <form method="POST" action="{{ route('admin.admin-users.store') }}" class="space-y-6">
            @csrf
