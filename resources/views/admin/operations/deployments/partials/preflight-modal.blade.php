            ...
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="flex items-start gap-4">
                    ...
                    >
                        ...
                        {{-- Failed --}}
                        <template x-if="!preflightLoading && preflightResult?.success === false">
                            <svg
                                class="h-5 w-5"
                                fill="none"
                                viewBox="0 0 24 24"
            ...
            <template x-if="!preflightLoading && preflightResult">
                ...
                <div class="space-y-5">
                    ...
                    <div
                        ...
                        :class="preflightResult.success !== false
                            ? 'bg-green-50'
                            : 'bg-red-50'"
                    >
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            {{-- Success --}}
                            <template x-if="preflightResult.success !== false">
                                <svg
                            ...
                            <div>
                                <p
                                    ...
                                    :class="preflightResult.success !== false
                                        ? 'text-green-900'
                                        : 'text-red-900'"
                                    x-text="preflightResult.success !== false
                            ...
                            <div class="rounded-lg border border-gray-100 p-4">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div
                                        ...
                                        :class="check.success !== false && check.passed !== false
                                            ? 'bg-green-50 text-green-600'
                                            : 'bg-red-50 text-red-600'"
                                    >

                                        {{-- Passed --}}
                                        <template x-if="check.success !== false && check.passed !== false">
                                            <svg
                                                class="h-4 w-4"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                        ...
                                        <div class="flex items-center justify-between gap-3">
                                            ...
                                            <span
                                                ...
                                                :class="check.success !== false && check.passed !== false
                                                    ? 'text-green-600'
                                                    : 'text-red-600'"
                                                x-text="check.success !== false && check.passed !== false
                                                    ? 'Passed'
                                                    : 'Failed'"
                                            ></span>
                    ...
                    >
                        ...
                        >
                            ...
                            <template x-if="!['success', 'message', 'error'].includes(key)">
