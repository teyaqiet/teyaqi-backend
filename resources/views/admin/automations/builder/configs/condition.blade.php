        ...
        <div class="relative">
            ...
            >
                ...
                <optgroup label="Game Completed">
                    ...
                    <option value="event.data.session_id">
                        Session ID
                    </option>

                    <option value="event.data.correct_answers">
                        Correct Answers
                    </option>

                    <option value="event.data.total_questions">
                        Total Questions
                    </option>

                    <option value="event.data.lives_lost">
                        Lives Lost
                    </option>

                    <option value="event.data.xp_earned">
                        XP Earned
                    </option>

                    <option value="event.data.perfect_bonus">
                        Perfect Bonus XP
                    </option>
                ...
                <optgroup label="Level Up">
                    ...
                    <option value="event.data.previous_level">
                        Previous Level
                    </option>

                    <option value="event.data.new_level">
                        New Level
                    </option>
                ...
                <optgroup label="Streak Reached">
                    ...
                    <option value="event.data.streak">
                        Streak Reached
                    </option>
                ...
                <optgroup label="XP Milestone">
                    ...
                    <option value="event.data.previous_xp">
                        Previous XP
                    </option>

                    <option value="event.data.new_xp">
                        New XP
                    </option>

                    <option value="event.data.milestone">
                        XP Milestone
                    </option>
                ...
                <optgroup label="Daily / Retention">
                ...
                <optgroup label="Challenge Completed">
                ...
                <optgroup label="Daily Challenge Completed">
