    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Add a new question category to Teyaqi.
            </p>
        </div>
            ...
            <div class="grid gap-5 md:grid-cols-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="h-11 w-full rounded-lg border border-gray-200 px-3 text-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 @error('icon') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('image_url') }}"
                        placeholder="https://..."
                        class="h-11 w-full rounded-lg border border-gray-200 px-3 text-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 @error('image_url') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror"
                    >
